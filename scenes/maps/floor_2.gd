...
func _init() -> void:
	...
	map_data = [
		["        ", "    ", "    ", "wall", "               ", "monster_def_lv1", "hp_herb               ", "wall", "hp_herb        ", "monster_spd_lv1", "boot_level1"],
		["        ", "spirit_stone", "    ", "    ", "monster_def_lv1", "               ", "monster_def_lv1", "wall", "monster_spd_lv1", "monster_spd_lv1", "hp_herb    "],
		["        ", "    ", "    ", "wall", "               ", "monster_def_lv1", "hp_herb               ", "wall", "wall           ", "               ", "wall       "],
	...
	items_config = {
		Vector2i(1, 1): 10 # Provide 10 spirit stones when picked up
	}